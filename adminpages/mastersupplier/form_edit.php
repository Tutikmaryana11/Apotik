...
include "../templates/header.php"; ?>
    ...
    <div class="col-md-10 col-sm-10 col-xs-12">
      <input type="text" id="first-name" name="id_supplier" value="<?php echo $dataSupplier['id_supplier'];?>" required="required" class="form-control col-md-7 col-xs-12">
    </div>

		<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Nama Supplier <span class="required">*</span>
		</label>
		<div class="col-md-10 col-sm-10 col-xs-12">
		  <input type="text" id="first-name" name="nama_supplier" value="<?php echo $dataSupplier['nama_supplier'];?>" required="required" class="form-control col-md-7 col-xs-12">
		</div>

    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Alamat Supplier <span class="required"></span>
    </label>
    <div class="col-md-10 col-sm-10 col-xs-12">
      <input type="text" id="first-name" name="alamat_supplier" value="<?php echo $dataSupplier['alamat_supplier'];?>" required="required" class="form-control col-md-7 col-xs-12">
    </div>

    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">No Telfon <span class="required"></span>
    </label>
    <div class="col-md-10 col-sm-10 col-xs-12">
      <input type="text" id="first-name" name="telpon" value="<?php echo $dataSupplier['telpon'];?>" required="required" class="form-control col-md-7 col-xs-12">
    </div>
